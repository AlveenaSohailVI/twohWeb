...
export class LoginComponent implements OnInit {
  ...
  LoginShow() {
    ...
    document.getElementById('registration-li').setAttribute('class', 'inactive underlineHover');

  }
  showRegistration() {
    this.showLogin = false;
    document.getElementById('login-li').setAttribute('class', 'inactive underlineHover');
