...
@Component({
  ...
  templateUrl: './start-shopping-uk.component.html',
  styleUrls: ['./start-shopping-uk.component.css']
})
export class StartShoppingUkComponent implements OnInit {
  ...
  EndShopping() {
    ...
    this.router.navigate(['/buyNowuk/shoppingCart']);
  }
